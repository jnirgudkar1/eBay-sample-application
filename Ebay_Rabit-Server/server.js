...
cnn.on('ready', function(){
	...
	cnn.queue('profile_queue', function(q){
		q.subscribe(function(message, headers, deliveryInfo, m){
			...
			util.log("Message: "+JSON.stringify(message));
			util.log("DeliveryInfo: "+JSON.stringify(deliveryInfo));
			login.profile_request(message, function(err,res){
...
cnn.on('ready', function(){
	console.log("listening on logout_queue");
...
cnn.on('ready', function(){
	...
	cnn.queue('allproducts_queue', function(q){
		q.subscribe(function(message, headers, deliveryInfo, m){
			...
			util.log("Message: "+JSON.stringify(message));
			util.log("DeliveryInfo: "+JSON.stringify(deliveryInfo));
			home.allproducts(message, function(err,res){
...
cnn.on('ready', function(){
	console.log("listening on addproduct_queue");
	...
	cnn.queue('addproduct_queue', function(q){
		q.subscribe(function(message, headers, deliveryInfo, m){
			...
			util.log("Message: "+JSON.stringify(message));
			util.log("DeliveryInfo: "+JSON.stringify(deliveryInfo));
			home.addproduct(message, function(err,res){
...
cnn.on('ready', function(){
	...
	cnn.queue('getcart_queue', function(q){
		q.subscribe(function(message, headers, deliveryInfo, m){
			...
			util.log("Message: "+JSON.stringify(message));
			util.log("DeliveryInfo: "+JSON.stringify(deliveryInfo));
			home.getcart(message, function(err,res){
...
cnn.on('ready', function(){
	...
	cnn.queue('removefromcart_queue', function(q){
		q.subscribe(function(message, headers, deliveryInfo, m){
			...
			util.log("Message: "+JSON.stringify(message));
			util.log("DeliveryInfo: "+JSON.stringify(deliveryInfo));
			home.removefromcart(message, function(err,res){
...
cnn.on('ready', function(){
	...
	cnn.queue('placebids_queue', function(q){
		q.subscribe(function(message, headers, deliveryInfo, m){
			util.log(util.format( deliveryInfo.routingKey, message));
			util.log("Message: "+JSON.stringify(message));
			util.log("DeliveryInfo: "+JSON.stringify(deliveryInfo));
			home.placebids(message, function(err,res){
...
cnn.on('ready', function(){
	...
	cnn.queue('checkout_queue', function(q){
		q.subscribe(function(message, headers, deliveryInfo, m){
			...
			util.log("Message: "+JSON.stringify(message));
			util.log("DeliveryInfo: "+JSON.stringify(deliveryInfo));
			home.checkout(message, function(err,res){
...
cnn.on('ready', function(){
	console.log("listening on allproducts queue with connection pool");

	cnn.queue('allproductsconnectionpool', function(q){
		q.subscribe(function(message, headers, deliveryInfo, m){
			util.log(util.format( deliveryInfo.routingKey, message));
			util.log("Message: "+JSON.stringify(message));
			util.log("DeliveryInfo: "+JSON.stringify(deliveryInfo));
			home.allproductswithconnectionpool(message, function(err,res){
